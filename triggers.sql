...
BEGIN
    -- Se realizó una operación de inserción
    INSERT INTO HISTORIAL (descripcion, tipo)
    VALUES ('SE REALIZO UNA ACCION EN LA TABLA HISTORIAL', 'INSERT');
END;
//
...
BEGIN
    -- Se realizó una operación de actualización
    INSERT INTO HISTORIAL (descripcion, tipo)
    VALUES ('SE REALIZO UNA ACCION EN LA TABLA HISTORIAL', 'UPDATE');
END;
//
...
BEGIN
    -- Se realizó una operación de eliminación
    INSERT INTO HISTORIAL (descripcion, tipo)
    VALUES ('SE REALIZO UNA ACCION EN LA TABLA HISTORIAL', 'DELETE');
END;
//
